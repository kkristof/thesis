...
\emph{OpenGL-ES 2.0} alapokon.
  ...
  Az előbb említett \emph{context} egy grafikus API~\footnote{Az
...
le\-pro\-gra\-mo\-zá\-sa~úgy, hogy a lehető legtöbb feladatot a grafikus
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \chapter*{Bevezetés}    \label{Bevezetés}
...
tervezését tűzte ki célul a Gepard Graphics csapata is. A \emph{Gepard}
a tervek szerint egy \emph{C++11}-es nyelven írt, és több (OpenGL,
...
Context}~\cite{Cabanier:14:HCC} nevű ajánlása.
...
elvárásokat. A path maga az definiált grafikus alakzatokhoz képest
