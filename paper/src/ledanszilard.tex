...
Ezekről a lépésekről is érdemes beszélni.
    ...
    \addcontentsline{toc}{subsection}{a tervezet}
...
vagy még pontosabban egy \emph{bit-térkép} (\inenglish{bitmap}) készül.
  ...
  Az ajánláson belül használt Path API rész amúgy egy régebbi, elterjedt
alakzatszerkesztő eljáráson alapul. Ezt az eljárást hívjuk alakzat
építésnek (\inenglish{path building}). A path építés
különböző elemek segítségével történik. Két fő részre
bontható. Az első rész tulajdonképpen nem is az építésre, mint
inkább a definiálásra és a rajzolásra vonatkozik. Míg a második
rész tartalmazza a path építéséhet szükséges parancsokat,
elemeket. Ezek a parancsok vagy elemek a következők:
    \begin{enumerate}[I.]
      \item Rajzoló parancsok:
        \begin{enumerate}
          \item \emph{beginPath}: egy állapot egyszerre csak egy
          path-t definiálhat. Ezzel a paranccsal kezdhetünk egy új
          path építeni. Fontos azonban, hogy nem kötelező ezzel
      ...
      \item Építő elemek, parancsok:
        \begin{enumerate}
          ...
          egyenest egy \emph{lineTo} eleme segítségével. Definíció
          ...
          definiált pontba egy \emph{lineTo} elem iktat.
          Parancsforma:\newline
